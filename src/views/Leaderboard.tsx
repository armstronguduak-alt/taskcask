        ...
        <div className="flex justify-center items-end gap-3 mt-4 mb-6 h-40">
          ...
          <div className="flex flex-col items-center">
            <div className="relative mb-2">
              <Avatar name={topEarners[1].name} size="md" className="border-4 border-gray-300 shadow-md" />
          ...
          <div className="flex flex-col items-center z-10 -mx-1">
            <div className="relative mb-2">
              ...
              <Avatar name={topEarners[0].name} size="lg" className="border-4 border-yellow-400 w-16 h-16 shadow-lg" />
          ...
          <div className="flex flex-col items-center">
            <div className="relative mb-2">
              <Avatar name={topEarners[2].name} size="md" className="border-4 border-orange-400 shadow-md" />
